      ...
      >
        <div className="flex ">
          ...
          <div className="text-end w-28 h-full bg-orange-600 pl-2 " >
            ...
            <button
              type="button"
              class="flex text-end justify-self-end text-gray-400 bg-transparent bg-gray-300 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto dark:hover:bg-gray-600 dark:hover:text-white"
