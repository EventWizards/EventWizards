...
function Foot() {
  ...
  // const hide =  window.location.pathname === '/profile/profilePrivate'
  //  const hide =  window.location.pathname === '/profile/orderTicket'
  //  const hide =  window.location.pathname === '/profile/orderEvent'
