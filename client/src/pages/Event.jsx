...
const Events = () => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const response = await axios.get('http://localhost:3001/category/getall');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     const categry= await axios.get('http://localhost:3001/category/getall')
      .then(response => {
      ...
      const response = await axios.post('http://localhost:3001/event/add', formDataObject);
console.log(formDataObject);
      ...
      <div className="mx-auto">
        <div className="flex justify-center px-6 py-12">
          <div className="w-full xl:w-3/4 lg:w-11/12 flex">
            ...
            <form className="px-8 pt-6 pb-8 mb-4 bg-white text-start  rounded" onSubmit={handleSubmit} encType="multipart/form-data">
              <div className="mb-4">
                ...
                <div className="mb-4 md:flex md:justify-between">
                <div className="mb-4">
                  <label className="block mb-2 text-sm font-bold text-gray-700 dark:text-black " htmlFor="image">
                  ID photo  *
                  </label>
                  <input
                ...
                <div className="mb-4">
                  ...
                  {/* <input
                    ...
                    value={formData.additions}
                     ...
                     required
                  /> */}
     <select className="w-full h-15 px-3 py-2 mb-3 text-sm leading-tight text-gray-700 dark:text-black  border rounded shadow appearance-none focus:outline-none focus:shadow-outline " onChange={(e) => setFormData({ ...formData, category_id: e.target.value })}>
  {options.map(option => (
