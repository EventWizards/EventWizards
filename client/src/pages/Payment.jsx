...
// //                   className="block w-36 rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-[#F9B530]"
// //                 />
// //               </div>
// //             </div>
// //           </div>
...
// //               className="mt-1 block w-full rounded border-gray-300 bg-gray-50 py-3 px-4 text-sm placeholder-gray-300 shadow-sm outline-none transition focus:ring-2 focus:ring-[#F9B530]"
// //             />
// //           </div>
// //         </form>
...
// //         <button
// //           type="submit"
// //           className="mt-4 inline-flex w-full items-center justify-center rounded bg-[#F9B530] py-2.5 px-4 text-base font-semibold tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100 focus:ring-2 focus:ring-teal-500 sm:text-lg"
// //         >
// //           Pay
// //         </button>
// //       </div>
...
// const stripePromise = loadStripe('pk_test_51OH5EWCYMi4UGQijzFJTPDGifOFe6UUyz8ISB1FLW4eNHtAfAI97kooFEKLqTk4j3vlukcA1NJAiwBQJ8GFdtP9Y00SPlFQ1Z7');
// const Payment = () => {
    ...
    <div className="product">
      ...
      />
       <div class="product-info">
          <h3 className="product-title">{productData.event_name}</h3>
          <h4 className="product-price">{productData.total}</h4>
        </div>
      <div>
        <Elements stripe={stripePromise}>
          <ElementsConsumer>
            {({ stripe, elements}) => <CheckoutForm stripe={stripe} elements={elements} productData={productData}/>}
          </ElementsConsumer>
        </Elements>
      </div>
    </div>
